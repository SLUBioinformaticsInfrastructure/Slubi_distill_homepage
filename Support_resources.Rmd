...
We would like to remind that researchers can get computing resources for free by [applying to SNIC (Uppmax and other clusters)](https://www.uppmax.uu.se/support/getting-started/applying-for-a-user-account/).
...
<center>
![](images/SLUBI_logo.png){#id .class width=15% height=15%}
</center>
